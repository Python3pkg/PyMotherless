...
'''
    ...
    $FileInfo: httpd.py - Last Update: 8/19/2016 Ver. 0.4.7 RC 2  - Author: cooldude2k $
'''
...
geturls_ua_midori_windows7 = pymotherless.geturls_ua_midori_windows7;
...
geturls_headers_midori_windows7 = pymotherless.geturls_headers_midori_windows7;
